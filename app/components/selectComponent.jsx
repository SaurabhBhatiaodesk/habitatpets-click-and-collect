        ...
        <div style={{ margin: "4px" }}>
          {field.is_cloneable ? (
            fields.map((fieldData, index) => (
              <div key={`${field.name}_${index}`} style={{ display: 'flex', alignItems: 'flex-start', maxHeight:'150px',width:'400px', overflow:'auto', marginBottom: '18px' }}>
                {field.multiple ? (
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: '18px', width:'400px', maxHeight:'150px', overflow:'auto', }}>
              {field.multiple ? (
                <ChoiceList
                  allowMultiple
                  title=""
